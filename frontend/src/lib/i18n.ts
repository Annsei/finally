...
const en: Dict = {
  ...
  // --- D2 additions (timed private competitions + portfolio risk) ------------
  // Arena competitions (D2 §5)
  'arena.compTitle': 'Competitions',
  'arena.compNamePlaceholder': 'Competition name…',
  'arena.compNameAria': 'Competition name',
  'arena.compHoursAria': 'Duration in hours',
  'arena.compHoursUnit': 'h',
  'arena.compCreate': 'Create',
  'arena.compCreating': 'Creating…',
  'arena.compCreateFailed': 'Create failed',
  'arena.compErrName': 'Enter a name (1–40 characters).',
  'arena.compErrHours': 'Hours must be a whole number between 1 and 168.',
  'arena.compErrCode': 'Enter an invite code.',
  'arena.compCodeLabel': 'Invite code',
  'arena.compCopy': 'Copy',
  'arena.compCopied': 'Copied',
  'arena.compCopyFailed': 'Copy failed',
  'arena.compJoinPlaceholder': 'Invite code…',
  'arena.compJoinAria': 'Invite code',
  'arena.compJoin': 'Join',
  'arena.compJoining': 'Joining…',
  'arena.compJoinFailed': 'Join failed',
  'arena.compLoading': 'Loading competitions…',
  'arena.compListEmpty': 'No competitions yet. Create one and share the invite code.',
  'arena.compMembers': '{n} traders',
  'arena.compFinal': 'Final standings',
  'arena.compStatus.upcoming': 'Upcoming',
  'arena.compStatus.running': 'Running',
  'arena.compStatus.ended': 'Ended',
  'arena.compColRank': '#',
  'arena.compColTrader': 'Trader',
  'arena.compColValue': 'Value',
  'arena.compColReturn': 'Return',
  'arena.compBoardLoading': 'Loading board…',
  'arena.compBoardEmpty': 'No members yet.',

  // Analytics risk cards (D2 §4/§5)
  'analytics.riskTitle': 'Risk',
  'analytics.var': 'VaR 95% (1d)',
  'analytics.beta': 'Beta',
...
const zh: Dict = {
  ...
  // --- D2 additions (timed private competitions + portfolio risk) ------------
  // Arena competitions (D2 §5)
  'arena.compTitle': '限时竞赛',
  'arena.compNamePlaceholder': '竞赛名称…',
  'arena.compNameAria': '竞赛名称',
  'arena.compHoursAria': '时长（小时）',
  'arena.compHoursUnit': '小时',
  'arena.compCreate': '创建',
  'arena.compCreating': '创建中…',
  'arena.compCreateFailed': '创建失败',
  'arena.compErrName': '请输入名称（1-40 字）。',
  'arena.compErrHours': '时长须为 1 到 168 之间的整数（小时）。',
  'arena.compErrCode': '请输入邀请码。',
  'arena.compCodeLabel': '邀请码',
  'arena.compCopy': '复制',
  'arena.compCopied': '已复制',
  'arena.compCopyFailed': '复制失败',
  'arena.compJoinPlaceholder': '邀请码…',
  'arena.compJoinAria': '邀请码',
  'arena.compJoin': '加入',
  'arena.compJoining': '加入中…',
  'arena.compJoinFailed': '加入失败',
  'arena.compLoading': '正在加载竞赛…',
  'arena.compListEmpty': '暂无竞赛。创建一场并分享邀请码。',
  'arena.compMembers': '{n} 人',
  'arena.compFinal': '终榜',
  'arena.compStatus.upcoming': '未开始',
  'arena.compStatus.running': '进行中',
  'arena.compStatus.ended': '已结束',
  'arena.compColRank': '#',
  'arena.compColTrader': '交易者',
  'arena.compColValue': '市值',
  'arena.compColReturn': '收益',
  'arena.compBoardLoading': '正在加载榜单…',
  'arena.compBoardEmpty': '暂无成员。',

  // Analytics risk cards (D2 §4/§5)
  'analytics.riskTitle': '风险',
  'analytics.var': 'VaR 95%（1日）',
  'analytics.beta': 'Beta',
