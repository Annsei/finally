...
<required_reading>
Read `/Users/maoqin/learning/ai-coder/finally/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
