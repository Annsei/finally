...
```bash
INIT=$(node "/Users/maoqin/learning/ai-coder/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/maoqin/learning/ai-coder/finally/.claude/get-shit-done/templates/spec.md.
