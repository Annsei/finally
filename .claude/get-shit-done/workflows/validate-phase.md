...
```
Agent(
  prompt="Read /Users/maoqin/learning/ai-coder/finally/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/maoqin/learning/ai-coder/finally/.claude/get-shit-done/templates/VALIDATION.md`
